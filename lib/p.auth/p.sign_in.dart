...
import 'package:medi_fypp/p.auth/p.signup.dart';
...
class PatientSignIn extends StatelessWidget {
  PatientSignIn({Key? key}) : super(key: key);
            ...
            SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      print(txt.text);
                      print(pass.text);
                      signInPatient('patient.${txt.text}', pass.text, context);
                    },
                    child: Text('Sign In')))
          ],
        ));
...
void signInPatient(email, pass, BuildContext context) async {
  try {
