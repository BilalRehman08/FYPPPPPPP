...
import 'package:medi_fypp/screens/Doctor%20Screen/DoctorHomePage.dart';

class HomePaien extends StatelessWidget {
  const HomePaien({Key? key}) : super(key: key);
      ...
      body: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => DoctorHomePage()));
            },
            child: Container(
              alignment: Alignment.center,
              decoration: BoxDecoration(
