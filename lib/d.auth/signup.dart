...
class DocotrSignUp extends StatelessWidget {
  DocotrSignUp({Key? key}) : super(key: key);
            ...
            children: [
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        createUSer('doctor.${email.text}', pass.text, context,
                            user.text);
                      },
                      child: Text('Sign Up')))
            ],
...
void createUSer(email, pass, context, name) async {
  try {
    ...
    //     context, MaterialPageRoute(builder: (_) => DoctorSignIn()));
